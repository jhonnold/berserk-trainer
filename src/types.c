...
const float psqtInitValues[] = {76.25f,  310.0f,  322.5f,  491.25f,  940.0f,  0.0f,
                                -76.25f, -310.0f, -322.5f, -491.25f, -940.0f, 0.0f};

const Square psqt[] = {0,  1,  2,  3,  3,  2,  1,  0,  4,  5,  6,  7,  7,  6,  5,  4,  8,  9,  10, 11, 11, 10,
